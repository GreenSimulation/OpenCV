...
void ControlWidget::OpenSolutionImage()
{
    ...
    if(listFileName.size()) {
        this->solution_image = cvLoadImage(listFileName.toLocal8Bit().data());
...
void ControlWidget::OpenListImage()
{
    ...
    if(listFileName.size()) {
        this->list_imagerd = cvLoadImage(listFileName.toLocal8Bit().data());
        this->gray_list_image = cvLoadImage(listFileName.toLocal8Bit().data(), CV_LOAD_IMAGE_GRAYSCALE);
...
bool ControlWidget::OpenImage()
{
    ...
    if(openFileName.size()) {
        imagerd = cvLoadImage(openFileName.toLocal8Bit().data());
        this->gray_image = cvLoadImage(openFileName.toLocal8Bit().data(),
